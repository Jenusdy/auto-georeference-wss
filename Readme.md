...
<video src="docs/tutorial.mp4" controls="controls" style="max-width: 100%;">
</video>

> [!NOTE]
> Anda dapat melihat atau mengunduh langsung berkas video tutorial di repository: [`docs/tutorial.mp4`](docs/tutorial.mp4).
